...
public class MultiDataSourceServiceImpl implements MultiDataSourceService {
    ...
    static final Logger LOG = LoggerFactory.getLogger(MultiDataSourceServiceImpl.class);
    ...
    public Connection getConnection(String id) throws SQLException {
        ...
        if (ds == null) throw new SQLException("Not found datasource service {}", id);
        return ds.getConnection();
    }

    @Override
    public void recycleConnection(String id, Connection conn) throws SQLException {
        DataSourceService ds = getDataSourceService(id);
        if (ds == null) throw new SQLException("Not found datasource service {}", id);
