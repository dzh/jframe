...
public class YunpianServiceImpl implements YunpianService {
	...
	@Override
	public void send(String text, String extend, String uid, String callback,
			String... mobile) {
		...
		for (int i = 0; i < mobile.length; i++) {
			...
			reqPara.put(YunpianConfig.Apikey,
					_config.getConf(null, YunpianConfig.Apikey));
	...
	@Override
	public void send(String text, String... mobile) {
		this.send(text, null, null, null, mobile);
	}
