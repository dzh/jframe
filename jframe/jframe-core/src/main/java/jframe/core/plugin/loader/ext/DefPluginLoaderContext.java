...
public class DefPluginLoaderContext implements PluginClassLoaderContext {
     ...
     * <clazz,pluginName>
     */
    private Map<String, String> exportClazz = Collections.synchronizedMap(new HashMap<String, String>());
     ...
     * @param clazzLoader
     */
    protected void putPluginClassLoader(String name, PluginClassLoader clazzLoader) {
